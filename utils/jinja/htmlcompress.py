...
class HTMLCompress(Extension):
	# FIXME: p - <p> Hell <a>o</a>
	isolated_elements = set(['script', 'style', 'noscript', 'textarea', 'title', 'p'])
	void_elements = set(['br', 'img', 'area', 'hr', 'param', 'input', 'embed', 'col'])
	block_elements = set(['div', 'section', 'article', 'nav', 'form', 'ul', 'ol', 'li', 'table', 'tr', 'tbody', 'thead', 'tfoot', 'tr', 'td', 'th', 'dl', 'dt', 'dd', 'blockquote', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'pre'])
